...
const colorMessage = (favoriteColor, shirtColor) => {
  ...
  } else return "That is a nice color.";
};

console.log(colorMessage("yellow", "pink")); // prints That is a nice color.
console.log(colorMessage("pink", "pink")); // printa The shirt is your favorite color!
